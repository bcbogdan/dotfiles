...
3.  **Coding Standards**:
    ...
    - **Descriptive Naming**: Test names must describe the _behavior_ being verified, not just the function name (e.g., `it('should throw 400 when payload is missing email')` vs `it('test create user')`).
